  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      if (isControlled) {
        ...
        localStorage.setItem('assanpay_theme', newTheme ? 'dark' : 'light');
      }
    };

    if (
      typeof document === 'undefined' ||
      typeof (document as Document & { startViewTransition?: (cb: () => void) => { ready: Promise<void>; finished: Promise<void> } }).startViewTransition !== 'function'
    ) {
      applyTheme();
      return;
    }
