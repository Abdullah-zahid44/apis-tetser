...
# Gateway Credentials (Server-only)
ASSANPAY_PKR_SANDBOX_BASE_URL=https://sandbox-api.assanpay.com
ASSANPAY_PKR_SANDBOX_API_KEY=your_key
ASSANPAY_PKR_SANDBOX_API_SECRET=your_secret

ASSANPAY_BDT_SANDBOX_BASE_URL=https://sandbox-bdt-api.assanpay.com
ASSANPAY_BDT_SANDBOX_API_KEY=your_key
ASSANPAY_BDT_SANDBOX_API_SECRET=your_secret
```
